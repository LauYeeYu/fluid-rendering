#ifndef FLUID_RENDERING_SRC_PARTICLE_H
...
{
public:
    Particle(Eigen::Vector3d _x) : x(_x), v(0.0f, 0.0f, 0.0f), m(PARTICLE_MASS), p(0.0f), pv(0.0f), d(0.0f), dv(0.0f), n(NULL) {}
...
#endif //FLUID_RENDERING_SRC_PARTICLE_H
